...
int main(int argc, char** argv) {
	...
	std::string OtherCostDir = "D:\\BSplineLearning\\pseudo_label\\cost\\ga\\test_" + std::to_string(point_num) + "\\";
	std::string CostDir = "D:\\BSplineLearning\\pseudo_label\\cost\\ga\\data_" + std::to_string(dataset_size) + "_wo_" + del_feat + "\\" + model_name + "\\test_" + std::to_string(point_num) + "\\";
	std::string OtherKnotDir = "D:\\BSplineLearning\\pseudo_label\\ga_knots\\test_" + std::to_string(point_num) + "\\";
	std::string KnotDir = "D:\\BSplineLearning\\pseudo_label\\ga_knots\\data_" + std::to_string(dataset_size) + "_wo_" + del_feat + "\\" + model_name + "\\test_" + std::to_string(point_num) + "\\";
	...
	do {
		...
		if (file.is_open()) {
			...
			if (in_crv_cls_file.is_open()) {
				...
				std::string class_path = "D:\\BSplineLearning\\pseudo_label\\seq_pred\\class\\test_" + std::to_string(point_num) + "\\" + file_id + "-r.txt";
