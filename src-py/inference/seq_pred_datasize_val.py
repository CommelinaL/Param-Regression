...
if __name__ == "__main__":
    ...
    print(del_feat)
    model_name = "MLP"
    model_dir = r"saved_model\\dataset_size_test\\" + model_name + "_wo_" + del_feat
    data_dir = r"D:\BSplineLearning\variable_length\split_dataset_"+str(seq_len)+r"\test"
    output_root_dir = r"D:\BSplineLearning\variable_length\split_dataset_"+str(seq_len) + "\\dataset_size_test\\" + model_name + "_wo_" + del_feat
